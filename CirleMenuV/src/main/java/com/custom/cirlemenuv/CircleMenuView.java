...
public class CircleMenuView extends FrameLayout {
    ...
    private class OnButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(final View view) {
            ...
            final Animator click = getButtonClickAnimation((CircleImageView)view);
    ...
    private void initButtons(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        ...
        for (int i = 0; i < buttonsCount; i++) {
            ...
            circleImageView.setImageResource(icons.get(i));
            circleImageView.setBackgroundTintList(ColorStateList.valueOf(colors.get(i)));
            circleImageView.setClickable(true);
            circleImageView.setOnClickListener(new OnButtonClickListener());
            circleImageView.setOnLongClickListener(new OnButtonLongClickListener());
            circleImageView.setScaleX(0);
            circleImageView.setScaleY(0);

            if( getScreenSizeInches((Activity) context) > 6.1){
                circleImageView.setLayoutParams(new LayoutParams(180, 180));
            } else {
                circleImageView.setLayoutParams(new LayoutParams(80, 80));
            }

            addView(circleImageView);
            mButtons.add(circleImageView);
        }
    }
    ...
    private Animator getButtonClickAnimation(final @NonNull CircleImageView button) {
        ...
        result.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    for (View b : mButtons) {
                        if (b != button) {
                            ((CircleImageView) b).setElevation(0);
                        }
                    }
                }
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    for (View b : mButtons) {
                        ((CircleImageView) b).setElevation(elevation);
                    }
